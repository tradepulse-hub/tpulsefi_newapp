...
const { board, handleCandyClick, selectedCandy, score } = useCandyCrushGame() // Destructure score

// Sync internal score state with hook's score
useEffect(() => {
...
return (
  ...
  >
    ...
    <p className="mt-8 text-lg text-white/80 text-center max-w-md">Instructions for the game</p>
  </div>
)
}
