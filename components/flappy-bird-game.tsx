...
const BIRD_SIZE = 30
const GRAVITY = 0.15 // Reduzido de 0.3 para 0.15 (metade)
const FLAP_STRENGTH = -4
const PIPE_WIDTH = 50
const PIPE_GAP = 120 // Revertido para o valor original, pois o usuário queria a distância ENTRE os obstáculos
const PIPE_SPEED = 1 // Metade da velocidade inicial
const PIPE_INTERVAL = 3000 // Dobrado de 1500 para 3000 para aumentar a distância entre os obstáculos
const COIN_SIZE = 20
