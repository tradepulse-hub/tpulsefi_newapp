...
export async function getQuote(tokenInAddress: string, tokenOutAddress: string, amountIn: string) {
  try {
    console.log("Getting quote for:", { tokenInAddress, tokenOutAddress, amountIn })
