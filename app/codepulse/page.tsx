...
const pageTranslations = {
  ...
  id: {
    ...
    pulsecode: {
      ...
      aboutTitle: "PulseCode", // Confirmed: This is already "PulseCode"
      aboutSubtitle: "Proyek yang menyatukan proyek", // Corrected translation
      description:
    ...
    <div className="min-h-screen text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <AnimatePresence>
        {activeFooterTab === "about" && (
          ...
          >
            <h1 className="text-5xl md:text-7xl font-extrabold mb-4 tracking-tight ml-8">
