              ...
              <div className="relative flex flex-wrap justify-center gap-6 max-w-2xl">
                ...
                {navigationItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    ...
                    <motion.div
                      className="w-16 h-16 bg-gradient-to-br from-gray-800/90 to-gray-900/95 backdrop-blur-xl border border-gray-600/50 rounded-lg flex items-center justify-center shadow-xl" // Increased size, rounded-lg, reduced shadow
                      style={{
                        transformStyle: "preserve-3d",
